  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>产销系统</span> <span class="label label-important">2</span></a>
       <ul>
        ...
        <li><a href="salaryper.jsp">销售部门</a></li>
      </ul>
     </li>
    <li> <a href="yardmanager.jsp"><i class="icon icon-inbox"></i> <span>货场管理系统</span></a> </li>
    <li><a href="productowner.jsp"><i class="icon icon-th"></i> <span>生产业主系统</span></a></li>
