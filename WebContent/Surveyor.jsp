  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="#"><i class="icon-signal"></i> <span>录入进场木材数据</span> <span class="label label-important">2</span></a></li>
        <li class="bg_ly span3"> <a href="widgets.html"> <i class="icon-inbox"></i><span class="label label-success"></span> 录入出场木材数据 </a> </li>
