...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>查询</span> <span class="label label-important">2</span></a>
       <ul>
        <li><a href="form-common.html">查询入场工单</a></li>
        <li><a href="form-validation.html">查询出场工单</a></li>
      </ul>
     </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>货场管理系统</span></a> </li>
    <li><a href="tables.html"><i class="icon icon-th"></i> <span>个人信息维护</span></a></li>
