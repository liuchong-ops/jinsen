...
<body>
<% outyard c=(outyard)request.getAttribute("outyard");
List<tree> t=null;
   t=(List<tree>)request.getAttribute("treeout");
%>
  ...
  <div id="content-header">
    ...
    <article class="artlce">
        <div class="book_con01" id="divprint">
            <h1 class="book_h01">录入出场木材信息</h1>
            <form  onSubmit="return inputNull(this)" action="treeServlet?action=updateTreeout" method="POST" >
            <div>
                <div class="top">
                   <p class="table_p"><span>树材信息录入</span></p>
                       <table class="table1">
                         <tr>
                          <td>销售工单号<span></span></td>
                          <td><input type="text" name="workid" id="wworkid" value="<%=c.getWorkid() %>" placeholder="销售工单号"></td>
                          <td>时间<span></span></td>
                          <td><input type="date" name="yarddate" id="yyarddate" value="<%=c.getYarddate() %>" placeholder="时间"></td>
                          <td>车牌号<span></span></td>
                          <td><input type="text" name="carnumber" id="ccarnumber" value="<%=c.getCarNumber() %>" placeholder="车牌号"></td>
                         </tr>
          ...
          <button class="btn btn-default" type="button"  onclick="treeAdd()" value="提交">提交</button>
                            ...
                            <!--  <table class="table1" >
                                ...
                                <tr style="font-size:20px">
                                   <td>货场<span></span></td>
                                   <td><input type="text" name="yard" id="yyard" placeholder="货场"></td>
                                   <td>检尺员<span></span></td>
                                   <td><input type="text" name="surveyor" id="ssurveyor" placeholder="检尺员"></td>
                                   <td>批次号<span></span></td>
                                   <td><input type="text" name="batchnum" id="bbratchum" placeholder="批次号"></td> 
                                </tr>
                                </tbody>
                            </table>-->
                        </div>
                   ...
                   <button class="but_save" type="button" value="返回" onclick="javascrtpt:window.location.href='treeout1.jsp'">返回添加</button></div>
